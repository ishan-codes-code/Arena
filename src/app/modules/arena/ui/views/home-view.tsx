        ...
        <div className="flex flex-col justify-between gap-12">
          <div>
            ...
            <h1 className="max-w-4xl font-display text-6xl font-black leading-[0.9] tracking-tight sm:text-8xl lg:text-[9rem]">
              PLAY
              <br />
              <span className="text-primary">FOR KEEPS.</span>
            </h1>
        ...
        <div id="tournaments" className="border border-border bg-card p-5 sm:p-7">
          ...
          <div className="py-12">
            ...
            <div className="mt-10 grid grid-cols-2 border-t border-border pt-5 font-mono text-xs uppercase">
              <div>
                <span className="block text-muted-foreground">Starts</span>
                <span className="mt-2 block text-sm text-foreground">Tonight / 9:00 PM</span>
              </div>
              <div>
                <span className="block text-muted-foreground">Prize pool</span>
                <span className="mt-2 block text-sm text-foreground">Vouchers / top 3</span>
              </div>
            </div>
          </div>
